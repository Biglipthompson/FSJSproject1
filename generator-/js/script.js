...
const quotes = [
  ...
  {quote: 'I had it in my heart. I believed in myself, and I had confidence. I knew how to do it, had natural talent and I pursued it',  person: 'Muhammad Ali', year: '1968'}
];
...
function getRandomQuote (arr) {
  var getRandomQuote = math.floor(math.random()*arr.length + 4);
