...
const quotes = [
  ...
  {quote: 'I had it in my heart. I believed in myself, and I had confidence. I knew how to do it, had natural talent and I pursued it', source: 'Muhammad Ali', year: '1968', citation: 'pro boxer muhammad ali'}
];
...
function printQuote () {
  ...
  if( quoteToPrint.citation = false){
    HTMLstring += `<span class="citation">${quoteToPrint.citation}</span>`
  }
  if(quoteToPrint.year = false){
    HTMLstring += `<span class="year">${quoteToPrint.year}</span></p>`
  }
